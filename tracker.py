...
class PerformanceTracker:
    ...
    def report(self, current_price: float, bot_stats: dict) -> str:
        ...
        lines = [
            ...
            f"  Total Fees:     ${bot_stats['total_fees']:,.2f} (maker ${bot_stats.get('maker_fees', 0):,.2f} + taker ${bot_stats.get('taker_fees', 0):,.2f})",
            f"  Slippage Cost:  ${bot_stats.get('slippage_cost', 0):,.2f}",
            f"  Total Cost:     ${bot_stats['total_fees'] + bot_stats.get('slippage_cost', 0):,.2f}",
